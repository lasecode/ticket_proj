...
async function loadAdminEvents() {
  ...
  if (!ok) { tbody.innerHTML = '<tr><td colspan="7" class="text-center text-muted">Failed to load events.</td></tr>'; return; }
...
async function saveEvent(e) {
  ...
  const payload = {
    ...
    location:     document.getElementById('field_location').value.trim(),
    ...
    total_tickets:parseInt(document.getElementById('field_total_tickets').value),
    is_featured:  document.getElementById('field_is_featured').checked,
  };
